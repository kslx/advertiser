...
class Config(object):
    ...
    def getMysqlHost(self):
        return self.config_file.get('MYSQL', 'host')

    def getMysqlPort(self):
        return self.config_file.get('MYSQL', 'port')

    def getMysqlUser(self):
        return self.config_file.get('MYSQL', 'user')

    def getMysqlPasswd(self):
        return self.config_file.get('MYSQL', 'passwd')

    def getMysqlDb(self):
        return self.config_file.get('MYSQL', 'db')
